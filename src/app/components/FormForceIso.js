...
function FormForceIso({indiceThird,is3Validated, setIs3Validated,autor3,setAutor3,dynaWeight1,setDynaWeight1,dynaWeight2,setDynaWeight2}) {
...
{is3Validated&&autor3? <button className="btn btn-warning">Modifier et Valider le résultat</button>:<button className="btn btn-success">Valider le résultat</button>}
</>
}
